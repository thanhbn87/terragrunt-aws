...
variable "source_sg01_id" { default = "" }
variable "source_sg01_tags" { default = { Type = "Bastion" } }
variable "source_sg02_id" { default = "" }
variable "source_sg02_tags" { default = { Type = "WebApp" } }
...
variable "db_rule1_desc" { default = "Bastion" }
variable "db_rule2_desc" { default = "WebApp" }
